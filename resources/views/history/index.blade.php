        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('history.search') }}" method="POST" class="flex flex-col items-center justify-center gap-5 sm:flex-row">
                        @csrf
                        ...
                        <div class="flex justify-center">
                            ...
                            dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">BUSCAR</button>
                        </div>
